...
const Dashboard = () => {
  ...
  return (
    <div className="w-full min-h-screen p-6 flex gap-6 flex-col lg:flex-row items-start">
      {/* Left Section */}
      <motion.div
      ...
      <motion.div
        className="flex-1 max-h-[500px] w-full bg-white rounded-lg shadow-lg p-4 overflow-hidden"
        initial={{ opacity: 0, x: 40 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.6 }}
      >
