...
const GigItem = ({
  ...
  console.log(gig)
  useState(() => {
    console.log(gig?.ratings?.average)
  }, [gig])
  return (
    <Link
    ...
    >
      <div className="rounded-l-4xl h-48 overflow-clip">
        <img
          ...
          src={gig?.gigImages[0]?.url || 'https://fiverr-res.cloudinary.com/image/upload/f_auto,q_auto,t_profile_original/v1/attachments/profile/photo/386c0b8f584977db82c71e4f78c778c2-1677686441502/27560ea0-c990-4abf-8964-2ca1a34db2fd.png'} alt="" />
      </div>
      <div
